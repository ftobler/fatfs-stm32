...
#define DO			gpio_ll_read(GPIOA, GPIO_PIN_6)	   /* Test for MMC DO ('H':true, 'L':false) */

#define DI_INIT()	/* Initialize port for MMC DI as output */
#define DI_H()		gpio_ll_set(GPIOA, GPIO_PIN_7)	/* Set MMC DI "high" */
#define DI_L()		gpio_ll_reset(GPIOA, GPIO_PIN_7)	/* Set MMC DI "low" */

#define CK_INIT()	/* Initialize port for MMC SCLK as output */
#define CK_H()		NOPN;gpio_ll_set(GPIOA, GPIO_PIN_5);NOPN;	/* Set MMC SCLK "high" */
#define	CK_L()		NOPN;gpio_ll_reset(GPIOA, GPIO_PIN_5);NOPN;	/* Set MMC SCLK "low" */

#define CS_INIT()	/* Initialize port for MMC CS as output */
#define	CS_H()		NOPN;gpio_ll_set(GPIOA, GPIO_PIN_9);NOPN;	/* Set MMC CS "high" */
#define CS_L()	    NOPN;gpio_ll_reset(GPIOA, GPIO_PIN_9);NOPN;	/* Set MMC CS "low" */
